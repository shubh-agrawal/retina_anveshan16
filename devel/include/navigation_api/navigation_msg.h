...
struct navigation_msg_
{
  ...
  _target_heading_type target_heading;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _start_crdnts_type;
  _start_crdnts_type start_crdnts;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _target_crdnts_type;
  _target_crdnts_type target_crdnts;
...
struct MD5Sum< ::navigation_api::navigation_msg_<ContainerAllocator> >
{
  ...
  {
    return "9a1c613c009062e1b0137332da96d004";
  }

  static const char* value(const ::navigation_api::navigation_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9a1c613c009062e1ULL;
  static const uint64_t static_value2 = 0xb0137332da96d004ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::navigation_api::navigation_msg_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.start_crdnts);
      stream.next(m.target_crdnts);
    }
...
struct Printer< ::navigation_api::navigation_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::navigation_api::navigation_msg_<ContainerAllocator>& v)
  {
    ...
    s << indent << "start_crdnts: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.start_crdnts);
    s << indent << "target_crdnts: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.target_crdnts);
  }
};
