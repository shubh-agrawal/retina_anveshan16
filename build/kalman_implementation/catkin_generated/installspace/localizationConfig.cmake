...
if("FALSE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/pi/doda_ws/src/kalman_implementation)
  set(localization_DEVEL_PREFIX /home/pi/doda_ws/devel)
  ...
  set(localization_INSTALL_PREFIX /home/pi/doda_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pi <siddharthjha@outlook.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/doda_ws/install/${idir}'.  Ask the maintainer 'pi <siddharthjha@outlook.com>' to fix it.")
    endif()
